...
D_IgG<-
  ...
  geom_hline(yintercept = 1, linetype="dotted", 
                color = "black", size=0.5)+
  geom_text(aes(1, 0.93, label = "Proposed cut-off=1.0", hjust = -.1), check_overlap = TRUE) +
  geom_text(aes(0.35, 1.77, label = "Outlier", hjust = -.1), check_overlap = TRUE) +
  ggtitle("Dog IgG") +
...
D_IgM<-sample_data %>% 
  ...
  theme(plot.title = element_text(hjust = 0.5)) +
  scale_color_manual(values = c("Masked pre-2019 serological control" = "black", "Housepet serum sample" = "coral"))+
  geom_text(aes(0.12, 2.3, label = "Outlier", hjust = -.1), check_overlap = TRUE) +
  ggtitle("Dog IgM") +
  xlab("Round 1") + ylab("Round 2") +
  xlim(0, 2.5) + ylim(0, 2.5)
```
...
C_IgG<-
  ...
  geom_hline(yintercept = 0.8, linetype="dotted", 
                color = "black", size=0.5)+
  geom_text(aes(0.8, 0.73, label = "Proposed cut-off=0.8", hjust = -.1), check_overlap = TRUE) +
  ggtitle("Cat IgG") +
  xlab("Round 1") + ylab("Round 2") +
  xlim(0, 2.5) + ylim(0, 2.5)
```
